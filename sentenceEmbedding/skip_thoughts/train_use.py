...
tf.flags.DEFINE_string("input_file_pattern", None,
                       ...
                       "tf.Example protos.")
tf.flags.DEFINE_string("input_file_pattern_snli", None,
                       "File pattern of sharded TFRecord files containing "
                       "tf.Example protos.")
...
def main(unused_argv):
    ...
    if not FLAGS.input_file_pattern_snli:
        raise ValueError("--input_file_pattern_snli is required.")
    if not FLAGS.train_dir:
        raise ValueError("--train_dir is required.")

    model_config = configuration.model_config(
        input_file_pattern=FLAGS.input_file_pattern, input_file_pattern_snli=FLAGS.input_file_pattern_snli)
